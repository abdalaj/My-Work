...
class Product extends Model implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'note','first_qty','is_price_percent','price_percent','is_service','didline'
    ];
    ...
    protected $appends = array('cost_price','sale_price','half_gomla_price','gomla_price','gomla_gomla_price','img');
    ...
    public function productUnit(){
        return $this->belongsToMany(Unit::class,'product_unit','product_id','unit_id')
            ->withPivot(['pieces_num','cost_price','sale_price','half_gomla_price','gomla_price','gomla_gomla_price'])
            ->withTimestamps()
    ...
    public function getTotalQuantity(){
        ...
        foreach ($this->productStore()->get() as $key => $store) {
            $unitName = Unit::find($store->pivot->unit_id)->name;
