...
class computersController extends Controller
{
    ...
    {
        $data=computers::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=computers::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/computers/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/computers/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/computers/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/computers/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/computers/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/computers/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/computers/',$filename6);
            $input['img6']=$filename6;
        }
        computers::create($input);
    ...
    public function show($id)
    {
        ...
        return view('computers/details',compact('data'));
    }
    ...
    {
        $data = computers::where('id',$id)->get();
        return view('computers.edit',compact('data'));
    }
    ...
    {
        $data = computers::findOrFail($id);
        //base_path();
        File::delete(base_path("images/computers/{$data->imghome}"));
        File::delete(base_path("images/computers/{$data->img1}"));
        File::delete(base_path("images/computers/{$data->img2}"));
        File::delete(base_path("images/computers/{$data->img3}"));
        File::delete(base_path("images/computers/{$data->img4}"));
        File::delete(base_path("images/computers/{$data->img5}"));
        File::delete(base_path("images/computers/{$data->img6}"));

        computers::findOrFail($id)->delete();
        return redirect('computers');
