...
class carController extends Controller
{
    ...
    {
        $data=car::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=car::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/car/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/car/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/car/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/car/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/car/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/car/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/car/',$filename6);
    ...
    public function show($id)
    {
        ...
        return view('car/details',compact('data'));
    }
    ...
    public function destroy($id)
    {
        ...
        //base_path();
        File::delete(base_path("images/car/{$data->imghome}"));
        File::delete(base_path("images/car/{$data->img1}"));
        File::delete(base_path("images/car/{$data->img2}"));
        File::delete(base_path("images/car/{$data->img3}"));
        File::delete(base_path("images/car/{$data->img4}"));
        File::delete(base_path("images/car/{$data->img5}"));
        File::delete(base_path("images/car/{$data->img6}"));
