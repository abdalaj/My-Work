...
class mobilesController extends Controller
{
    ...
    {
        $data=mobiles::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=mobiles::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/mobiles/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/mobiles/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/mobiles/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/mobiles/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/mobiles/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/mobiles/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/mobiles/',$filename6);
            $input['img6']=$filename6;
        }
        mobiles::create($input);
    ...
    public function show($id)
    {
        ...
        return view('mobiles/details',compact('data'));
    }
    ...
    {
        $data = mobiles::where('id',$id)->get();
        return view('mobiles.edit',compact('data'));
    }
    ...
    {
        $data = mobiles::findOrFail($id);
        //base_path();
        File::delete(base_path("images/mobiles/{$data->imghome}"));
        File::delete(base_path("images/mobiles/{$data->img1}"));
        File::delete(base_path("images/mobiles/{$data->img2}"));
        File::delete(base_path("images/mobiles/{$data->img3}"));
        File::delete(base_path("images/mobiles/{$data->img4}"));
        File::delete(base_path("images/mobiles/{$data->img5}"));
        File::delete(base_path("images/mobiles/{$data->img6}"));

        mobiles::findOrFail($id)->delete();
        return redirect('mobiles');
