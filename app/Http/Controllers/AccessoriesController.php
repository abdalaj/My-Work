...
class AccessoriesController extends Controller
{
    ...
    {
        $data=accessories::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=accessories::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/accessories/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/accessories/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/accessories/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/accessories/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/accessories/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/accessories/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/accessories/',$filename6);
    ...
    public function show($id)
    {
        ...
        return view('accessories/details',compact('data'));
    }
    ...
    {
        $data = accessories::where('id',$id)->get();
        return view('accessories.edit',compact('data'));
    }
    ...
    public function destroy($id)
    {
        ...
        //base_path();
        File::delete(base_path("images/accessories/{$data->imghome}"));
        File::delete(base_path("images/accessories/{$data->img1}"));
        File::delete(base_path("images/accessories/{$data->img2}"));
        File::delete(base_path("images/accessories/{$data->img3}"));
        File::delete(base_path("images/accessories/{$data->img4}"));
        File::delete(base_path("images/accessories/{$data->img5}"));
        File::delete(base_path("images/accessories/{$data->img6}"));
