...
class beautyController extends Controller
{
    ...
    {
        $data=beauty::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=beauty::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/beauty/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/beauty/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/beauty/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/beauty/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/beauty/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/beauty/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/beauty/',$filename6);
    ...
    public function show($id)
    {
        ...
        return view('beauty/details',compact('data'));
    }
    ...
    {
        $data = beauty::where('id',$id)->get();
        return view('beauty.edit',compact('data'));
    }
    ...
    {
        $data = beauty::findOrFail($id);
        //base_path();
        File::delete(base_path("images/beauty/{$data->imghome}"));
        File::delete(base_path("images/beauty/{$data->img1}"));
        File::delete(base_path("images/beauty/{$data->img2}"));
        File::delete(base_path("images/beauty/{$data->img3}"));
        File::delete(base_path("images/beauty/{$data->img4}"));
        File::delete(base_path("images/beauty/{$data->img5}"));
        File::delete(base_path("images/beauty/{$data->img6}"));

        beauty::findOrFail($id)->delete();
        return redirect('beauty');
