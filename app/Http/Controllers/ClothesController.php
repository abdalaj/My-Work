...
class clothesController extends Controller
{
    ...
    {
        $data=clothes::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=clothes::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/clothes/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/clothes/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/clothes/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/clothes/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/clothes/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/clothes/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/clothes/',$filename6);
            $input['img6']=$filename6;
        }
        clothes::create($input);
    ...
    public function show($id)
    {
        ...
        return view('clothes/details',compact('data'));
    }
    ...
    {
        $data = clothes::where('id',$id)->get();
        return view('clothes.edit',compact('data'));
    }
    ...
    {
        $data = clothes::findOrFail($id);
        //base_path();
        File::delete(base_path("images/clothes/{$data->imghome}"));
        File::delete(base_path("images/clothes/{$data->img1}"));
        File::delete(base_path("images/clothes/{$data->img2}"));
        File::delete(base_path("images/clothes/{$data->img3}"));
        File::delete(base_path("images/clothes/{$data->img4}"));
        File::delete(base_path("images/clothes/{$data->img5}"));
        File::delete(base_path("images/clothes/{$data->img6}"));

        clothes::findOrFail($id)->delete();
        return redirect('clothes');
