...
class electronicsController extends Controller
{
    ...
    {
        $data=electronics::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=electronics::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/electronics/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/electronics/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/electronics/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/electronics/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/electronics/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/electronics/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/electronics/',$filename6);
            $input['img6']=$filename6;
        }
        electronics::create($input);
    ...
    public function show($id)
    {
        ...
        return view('electronics/details',compact('data'));
    }
    ...
    {
        $data = electronics::where('id',$id)->get();
        return view('electronics.edit',compact('data'));
    }
    ...
    {
        $data = electronics::findOrFail($id);
        //base_path();
        File::delete(base_path("images/electronics/{$data->imghome}"));
        File::delete(base_path("images/electronics/{$data->img1}"));
        File::delete(base_path("images/electronics/{$data->img2}"));
        File::delete(base_path("images/electronics/{$data->img3}"));
        File::delete(base_path("images/electronics/{$data->img4}"));
        File::delete(base_path("images/electronics/{$data->img5}"));
        File::delete(base_path("images/electronics/{$data->img6}"));

        electronics::findOrFail($id)->delete();
        return redirect('electronics');
