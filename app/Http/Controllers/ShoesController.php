...
class shoesController extends Controller
{
    ...
    {
        $data=shoes::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
        if (Auth::user()->gender == 'admin' && Auth::user()->type == 'الكل') {
            $data=shoes::orderByDesc('id')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/shoes/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/shoes/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/shoes/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/shoes/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/shoes/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/shoes/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/shoes/',$filename6);
    ...
    public function show($id)
    {
        ...
        return view('shoes/details',compact('data'));
    }
    ...
    {
        $data = shoes::where('id',$id)->get();
        return view('shoes.edit',compact('data'));
    }
    ...
    public function destroy($id)
    {
        ...
        //base_path();
        File::delete(base_path("images/shoes/{$data->imghome}"));
        File::delete(base_path("images/shoes/{$data->img1}"));
        File::delete(base_path("images/shoes/{$data->img2}"));
        File::delete(base_path("images/shoes/{$data->img3}"));
        File::delete(base_path("images/shoes/{$data->img4}"));
        File::delete(base_path("images/shoes/{$data->img5}"));
        File::delete(base_path("images/shoes/{$data->img6}"));
