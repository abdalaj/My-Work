...
class booksController extends Controller
{
    ...
    {
        $data=books::orderByDesc('id')->where('user_item_id',Auth::user()->id)->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($imghome) {
            ...
            $imghome->move('images/books/',$filename);
        ...
        if ($img1) {
            ...
            $img1->move('images/books/',$filename1);
        ...
        if ($img2) {
            ...
            $img2->move('images/books/',$filename2);
        ...
        if ($img3) {
            ...
            $img3->move('images/books/',$filename3);
        ...
        if ($img4) {
            ...
            $img4->move('images/books/',$filename4);
        ...
        if ($img5) {
            ...
            $img5->move('images/books/',$filename5);
        ...
        if ($img6) {
            ...
            $img6->move('images/books/',$filename6);
    ...
    public function destroy($id)
    {
        ...
        //base_path();
        File::delete(base_path("images/books/{$data->imghome}"));
        File::delete(base_path("images/books/{$data->img1}"));
        File::delete(base_path("images/books/{$data->img2}"));
        File::delete(base_path("images/books/{$data->img3}"));
        File::delete(base_path("images/books/{$data->img4}"));
        File::delete(base_path("images/books/{$data->img5}"));
        File::delete(base_path("images/books/{$data->img6}"));
