        ...
        <div class="mdl-card mdl-shadow--2dp" >
            ...
            <div class="mdl-card__title">
                ...
                <div class="mdl-card__supporting-text">
                    <form class="form form--basic" action="{{ route('social.update',$item['id']) }}" method="POST" >
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone form__article">
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                ...
                                <input class="mdl-textfield__input" type="url" value="{{ $item['facebook'] }}"  name="facebook">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Twitter </label>
                                <input class="mdl-textfield__input" type="url" value="{{ $item['twitter'] }}" name="twitter">
                            </div>
                        ...
                        <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone form__article">
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                ...
                                <input class="mdl-textfield__input" type="url" value="{{ $item['instagrame'] }}"  name="instagrame">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Youtube </label>
                                <input class="mdl-textfield__input" type="url" value="{{ $item['youtube'] }}" name="youtube">
                            </div>
