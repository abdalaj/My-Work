				...
				<!-- /.box-header -->
					<div class="box-body">
						<table class="table table-bordered">
							...
							<tr>
								<td>إيجار</td>
								<td><a href="" class="btn btn-warning btn-block">400</a></td>
							</tr>
							<tr>
								<td>كهرباء</td>
								<td><a href="" class="btn btn-warning btn-block">200</a></td>
							</tr>
							<tr>
								<td>مشال</td>
								<td><a href="" class="btn btn-warning btn-block">600</a></td>
							</tr>
							<tr>
								<td>ناصر</td>
								<td><a href="" class="btn btn-warning btn-block">2800</a></td>
							</tr>
							</tbody>
							<tfoot>
							<tr>
								<td>إجمالى المصاريف</td>
								<td><a href="" class="btn btn-primary btn-block">4000</a></td>
							</tr>
							</tfoot>
						</table>
