...
@endsection
@section('content')
@if (Auth::user()->type =='ملابس' || Auth::user()->type =='الكل')
    <br />
    <br />
    <a  href="/clothe/create" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['imghome'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['img1'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['img2'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['img3'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['img4'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['img5'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/clothes/{{ $item['img6'] }}" width="50" height="50" />
                                </td>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="{{ route('clothes.show',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric edit">
                                        <a href="{{ route('clothes.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple">
