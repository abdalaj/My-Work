      ...
      <div class="col-lg-3 col-md-6 col-sm-6 mb-5  col-sm- p-0  " >
          <div class="row  align-items-stretch justify-content-between">
            ...
            <div class="col-3 "  style="padding-left: 0;">
              <img class="mb-3" src="https://dash.faster-eg.com/images/clothes/{{ $item->imghome }}" style="width: 100%;" alt="">
              <img class="mb-3" src="https://dash.faster-eg.com/images/clothes/{{ $item->img1 }}" style="width: 100%;" alt="">
              <img class="" src="https://dash.faster-eg.com/images/clothes/{{ $item->img2 }}" style="width: 100%;" alt="">
            </div>
            <div class="col-9 zoom" style="padding-right: 0;">
                <img  src="https://dash.faster-eg.com/images/clothes/{{ $item->imghome }}" style="width: 100%;height: 100%;" alt="">
            </div>
            <div class="col-12 mt-2 " style="display: flex;align-items: stretch; justify-content: space-between; flex-wrap: wrap;" >
                <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/clothes/{{ $item->img3 }}" style="width: 100%;" alt=""></div>
                <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/clothes/{{ $item->img4 }}" style="width: 100%;" alt=""></div>
                <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/clothes/{{ $item->img5 }}" style="width: 100%;" alt=""></div>
                <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/clothes/{{ $item->img6 }}" style="width: 100%;" alt=""></div>
            </div>
                ...
                <div class="modal-content">
                  ...
                  <form action="/order" method="POST">
                    ...
                    <div class="modal-body " >
                        ...
                        <div class="form-group">
                        <label for="details"> المقاس واللون</label>
