    ...
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
        <div class="mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__supporting-text">
                <form action="{{ route('toys.store')}}" enctype="multipart/form-data" method="POST" class="form form--basic" >
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone form__article">
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px">Name Of toys</label> ( الاسم العام للمنتج )
                                <input class="mdl-textfield__input" type="text" value="{{ Auth::user()->type }}"  name="name">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Saler Of toys</label> (  اسم محلك )
                                <input class="mdl-textfield__input" type="text" value="{{ Auth::user()->name_market }}" name="saler">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Address Of toys</label> ( عنوان محلك )
                                <input class="mdl-textfield__input" type="text"  value="{{ Auth::user()->address }}" name="address">
                            </div>

                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Summry Of toys</label> (  وصف بسيط قوي عن المنتج )
                                <input class="mdl-textfield__input" type="text" name="summry">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px"> Describ Of toys</label> (  كل تفاصل المنتج )
                                <input class="mdl-textfield__input" type="text" name="describ">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Number Of toys</label> ( الكميه المتاحه عندك في المخزن )
                                <input class="mdl-textfield__input" type="text" name="number">
                            </div>

                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Price Of toys</label> (  سعر المنتج قبل الخصم )
                                <input class="mdl-textfield__input" type="text" name="price">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Discount Of toys</label> ( السعر بعد الخصم )
                                <input class="mdl-textfield__input" type="text" name="discount">
                            </div>

                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Color Of toys</label> (  الالوان المتاحه للمنتج دا )
