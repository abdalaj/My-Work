...
@if (Auth::user()->type =='طعام وسوبر ماركت' || Auth::user()->type =='الكل')
    <br />
    <br />
    <a  href="/toy/create" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['imghome'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['img1'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['img2'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['img3'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['img4'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['img5'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/toys/{{ $item['img6'] }}" width="50" height="50" />
                                </td>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="{{ route('toys.show',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric edit">
                                        <a href="{{ route('toys.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric delete">
                                        <form action="{{ route('toys.destroy',$item['id']) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
