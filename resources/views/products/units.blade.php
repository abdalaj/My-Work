<div class="col-md-12 unitRow">
        ...
        <div class="col-md-12 ">
            ...
            <div class="form-group col-md-6">
                <div class="input-group">
                    <div class="input-group-addon">@lang('front.Calculate price increase') <input class="flat-red" id="priceCalcualtion" name="product[is_price_percent]" @if($product->is_price_percent || !$product->id) checked @endif type="checkbox"></div>
                    <input class="form-control" id="pricePercentage" value="{{$product->price_percent}}" name="product[price_percent]" type="number" placeholder="@lang('front.The percentage of the sectoral price increase over the wholesale')">
    ...
    <div class="col-md-1">
        <div class="form-group">
            ...
            @php
                if(isset($unit3->pivot->pieces_num) && $i==3){
