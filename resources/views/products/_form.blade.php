                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input required value="{{$product->observe?:10}}" name="product[observe]" type="number" class="form-control disableEnter">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>السريال</label>
                                                    <select name="serial[]" multiple class="form-control select2 select3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->didline?:''}}" name="didline" type="date" class="form-control ">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="box__">
                                <div class="box-body">
                                    ...
                                    @endforeach
                                    @foreach(\App\Store::whereNotin('id',$sids)->get() as $store)
                                        @php
                                            $i++;
                                            $sids[] = $store->id;
                                        @endphp
    ...
    $(function () {
        ...
        $('body').on('change','.cost_price',function(e){
            ...
            if($("#priceCalcualtion").is(':checked')) {
                ...
                if(percentage2){
                    var price = calaculateCost(oldCost,percentage2);
