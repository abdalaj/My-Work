                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    @foreach($product->totalQuantities() as $store)
                                        <tr>
                                            <pre>
                                                {{  $store }}
                                            </pre>
                                ...
                                <table class="table table-bordered dataTableTT">
                                    ...
                                    @foreach($product->orders as $order)
                                        <tr>
                                            ...
                                            <td>{{optional($order->invoice->saleMan)->name}}</td>
                                            <td>{{$order->invoice->client->name}}</td>
                                            <td>{{$order->qty}}</td>
                                            <td>{{$order->price}}</td>
                                            <td>{{$unit}}</td>
                                        </tr>
                                ...
                                <table style="width: 100%;" class="table table-bordered dataTableTT">
                                    ...
                                    @foreach($product->ordersreturn as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->returns->client->name}}</td>
            ...
            <div class="col-md-12">
                <div class="box box-warning collapsed-box">
                    ...
                    <div class="box-body" style="display: none;">
                        <div class="row">
                            <div class="col-md-12">
                                <table style="display: none;" class="table table-bordered dataTableTT">
                                    <thead>
                                    <tr>
