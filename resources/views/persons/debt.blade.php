...
@push('dataTableJs')
    <script>
        var pageUrl = "{{$type=='client'?route('client.index',['isdebt'=>true]):route('supplier.index',['isdebt'=>true])}}";
        var columns= [
            {data: "id", name: "id"},
            {data: "name", name: "name"},
            {data: "mobileData", name: "mobile"},
            {data: "balnce_text", name: "balnce_text", orderable: false, searchable: false},
            {data: "last_order", name: "last_order", orderable: false, searchable: false},
            {data: "last_transaction", name: "last_transaction", orderable: false, searchable: false},
            {data: "last_transaction_value", name: "last_transaction_value", orderable: false, searchable: false},
