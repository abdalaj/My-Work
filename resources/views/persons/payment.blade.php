			...
			<div class="box box-primary">
				<div class="box-body">
					<div class="row">
                        ...
                        <div class="{{($person->type=='client')?'col-md-12':'hide'}}">
                            <div class="form-group">
						...
						<div class="{{($person->type=='client')?'col-md-6':'hide'}}">
							<div class="form-group">
								<label>@lang('front.Additional discount') </label>
						...
						<div class="{{($person->type=='client')?'col-md-6':'col-md-12'}}">
							<div class="form-group">
								<label>@lang('front.value')</label>
								<div class="input-group">
									<div class="input-group-addon ">
										<i class="fa fa-money"></i>
										<span id="personBalance">{{round($person->total_due,1)}}</span>
									</div>
									<input id="personPaidMoney" value="" name="value" required type="number" step="0.01" class="form-control pull-right">
									<span class="input-group-addon btn ">
										<span id="PersonDue">{{round($person->total_due,1)}}</span>
									</span>
