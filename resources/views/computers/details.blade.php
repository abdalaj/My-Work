...
<br />
<a style="margin-left:25px" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" href="{{ route('computers.index')}}">
                ...
                <form class="form form--basic" >
                   ...
                   <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone form__article">
                        ...
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px" >Stauts Of computers</label>
                            <input disabled class="mdl-textfield__input" value="{{ $item['stauts'] }}" type="text" >
                        </div>
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px">Charge Of computers</label>
                            <input disabled class="mdl-textfield__input" value="{{ $item['charge'] }}" type="text" >
                        </div>
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px" >Securty Of computers</label>
