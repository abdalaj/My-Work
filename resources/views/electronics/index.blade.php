...
@endsection
@section('content')
@if (Auth::user()->type =='الكترونيات' || Auth::user()->type =='الكل')
    <br />
    <br />
    <a  href="/electronic/create" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['imghome'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['img1'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['img2'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['img3'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['img4'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['img5'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/electronics/{{ $item['img6'] }}" width="50" height="50" />
                                </td>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="{{ route('electronics.show',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric edit">
                                        <a href="{{ route('electronics.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric delete">
                                        <form action="{{ route('electronics.destroy',$item['id']) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
