    ...
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
        <div class="mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__supporting-text">
                <form action="{{ route('electronics.store')}}" enctype="multipart/form-data" method="POST" class="form form--basic" >
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone form__article">
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px">Name Of electronics</label> ( الاسم العام للمنتج )
                                <input class="mdl-textfield__input" type="text" value="{{ Auth::user()->type }}"  name="name">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Saler Of electronics</label> (  اسم محلك )
                                <input class="mdl-textfield__input" type="text" value="{{ Auth::user()->name_market }}" name="saler">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Address Of electronics</label> ( عنوان محلك )
                                <input class="mdl-textfield__input" type="text"  value="{{ Auth::user()->address }}" name="address">
                            </div>

                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Summry Of electronics</label> (  وصف بسيط قوي عن المنتج )
                                <input class="mdl-textfield__input" type="text" name="summry">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px"> Describ Of electronics</label> (  كل تفاصل المنتج )
                                <input class="mdl-textfield__input" type="text" name="describ">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Number Of electronics</label> ( الكميه المتاحه عندك في المخزن )
                                <input class="mdl-textfield__input" type="text" name="number">
                            </div>

                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Price Of electronics</label> (  سعر المنتج قبل الخصم )
                                <input class="mdl-textfield__input" type="text" name="price">
                            </div>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Discount Of electronics</label> ( السعر بعد الخصم )
                                <input class="mdl-textfield__input" type="text" name="discount">
                            </div>

                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px" >Color Of electronics</label> (  الالوان المتاحه للمنتج دا )
