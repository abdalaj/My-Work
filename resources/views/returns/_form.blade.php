                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="order_id" class="form-control select2" name="order[order_id]">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="{{$settings['show_category_in_invoice']==1?'col-md-3':'col-md-4'}}">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input style="min-width: 220px;" id="productQty" value="1" min="0" step="0.01" type="number" type="text" class="form-control qty" >
        ...
        if(suggestion.is_service==1){
            ...
            $.each(suggestion.product_store, function( index, item ) {
                ...
                if(selectedStore==item.id) {
                    ...
                    $('#invoiceProductList').find('#unitQty').html(avilable + ' '+units[item.pivot.unit_id]);
                    ...
                    if(avilable>0){
                        ...
                        swal({
                            title:'خطأ', text:"الكمية غير متاحة",type:"error",confirmButtonText: "تمام",
                        });
                        @endif
                    }
        ...
        source: new Bloodhound({
            ...
            remote: {
                ...
                prepare: function (query, settings) {
                    ...
                    +'&category_id='+$('#category_id').val()+'&store_id='+$('#productStores').val();
                    @if($type!='sales')
