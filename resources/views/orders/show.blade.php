                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            @if($settings['logo'])
                                                <div class="logo">
                                                    <img src="{{ asset('logo') }}/{{ $settings['logo'] }}" alt="" height="120px">
                                                </div>
                                            @endif
                                            <div class="pull-left">
                                                <h4>
                                        ...
                                        <div class="col-md-6">
                                            <h5 style="line-height: 25px;font-size: {{$settings['PrintSize']+2}}px!important;" class="pull-right">@lang('front.invoicenumber') : {{$order->invoice_number}}<br>
                                                ...
                                                @lang('front.payment') : {{ (in_array($order->payment_type,['cash','delayed']))?trans('app.'.$order->payment_type):$order->payment_type}} <br/>
                        ...
                        <div  class="col-md-12 text-center">
                            <h3>
                                @if($order->invoice_type=='sales')
                                    @lang('front.order') @if($order->is_withdrawable==1)| مسحوبات  @endif
                                @else
                                    @lang('front.purchase')
                                @endif
                            </h3>
                                                    ...
                                                    <td style="border: none!important;" colspan="2">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="no-line text-center">{{currency($order->total,$order->currency, currency()->getUserCurrency(), $format = true)}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="no-line text-center">@lang('front.tax') : {{$order->tax}}%</td>
                                                            ...
                                                            <tr>
                                                                <td class="no-line text-center">@lang('front.paid') : {{currency($order->getOriginal('paid'),$order->currency, currency()->getUserCurrency(), $format = true)}} </td>
                                                                <td class="no-line text-center">@lang('front.due') : {{$order->due}}  </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="no-line text-center">{{currency($order->client->total_due-$order->due,$order->currency, currency()->getUserCurrency(), $format = true)}}  </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="no-line text-center text-bold">@lang('front.balance') :</td>
                                                                <td class="no-line text-center text-bold">{{$order->client->balnce_text}}  </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
