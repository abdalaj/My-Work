...
<div class="box box-primary">
        <div class="box-body">
            ...
            <div id="invoiceProductList">
                    ...
                    {{-- <div class="col-12 col-md-11">
                        <div class="form-group">
                            <label class="control-label">السريال</label>
                ...
                <div class="modal-body calanderList">
                    <div class="row">
                        <div class="col-md-12" style="text-align: left">
                            <input id="QestNumInput" type="number" name="count" value="" placeholder="اكتب عدد الأقساط">
                            <a id="totalQest" style=" margin: 5px 22px; " class="btn btn-sm bg-warning">إجمالى القسط: 0</a>
    ...
    <div class="box-footer" style="position: absolute;top: -55px;background: none;{{(\Session::get ('locale') == 'ar')?'left: 15px;':'right:15px;'}}">
            ...
            @if($type!='sales')
            <button type="submit" class="btn btn-primary saveandPrintBarcode"><i class="fa fa-barcode"></i> حفظ وطباعة باركود </button>
            @endif
        </div>
    </div>
