...
@section('content')
    <br />
    <br />
    <a  href="{{ route('room.create') }}" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
        ...
        <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
            <div class="mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h1 class="mdl-card__title-text">All Room Of Me</h1>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">{{ $item['name'] }}</td>
                                    <td class="mdl-data-table__cell--non-numeric edit" >
                                        <a href="{{ route('room.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple" style="padding: 0 !important">
                                            <i class="material-icons">create</i>
                                        </a>
                                        <form style="display: inline-block" action="{{ route('room.destroy',$item['id']) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
