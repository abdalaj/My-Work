    ...
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
        <div class="mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__supporting-text">
                <form action="{{ route('sill.store')}}" enctype="multipart/form-data" method="POST" class="form form--basic" >
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone form__article">
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <label style="margin-bottom:15px">ٍٍٍٍٍٍٍSill</label>
                                <input class="mdl-textfield__input" type="text" value=""  name="sill">
                            </div>
                        </div>
                    </div>
