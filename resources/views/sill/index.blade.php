...
@if ( Auth::user()->type =='الكل')
    <br />
    <br />
    <a  href="/sill/create" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                    ...
                    <table class="mdl-data-table mdl-js-data-table bItemsed-table">
                        <thead>
                            <tr>
                                ...
                                <th class="mdl-data-table__cell--non-numeric">Sill</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">{{ $item['sill'] }}</td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="{{ route('sill.show',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric edit">
                                        <a href="{{ route('sill.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric delete">
                                        <form action="{{ route('sill.destroy',$item['id']) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
