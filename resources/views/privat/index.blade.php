...
@if ( Auth::user()->type =='الكل')
    <br />
    <br />
    <a  href="/privat/create" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                    ...
                    <table class="mdl-data-table mdl-js-data-table bItemsed-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">{{ $item['private'] }}</td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="{{ route('privat.show',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric edit">
                                        <a href="{{ route('privat.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric delete">
                                        <form action="{{ route('privat.destroy',$item['id']) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
