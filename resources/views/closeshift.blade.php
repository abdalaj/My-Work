            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input  class="form-control" value="@lang('front.CloseShift')" type="text" name="note">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="">@lang('front.date')</label>
                        <input readonly name="op_date" value="{{date('Y-m-d')}}"  type="text" class="form-control datepicker22"   placeholder="التاريخ">
                    </div>
                    <div class="form-group col-md-12">
                        <label>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input max="{{$cash}}"  name="value" min="0" type="number" step="0.01" class="form-control paid" required="required">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="">@lang('front.balance after')</label>
                        <input name="due"  min="0" type="number" step="0.01" class="form-control due" required="required">
                    </div>
