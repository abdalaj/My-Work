...
<br />
<a style="margin-left:25px" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" href="{{ route('accessories.index')}}">
                ...
                <form class="form form--basic" >
                   ...
                   <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone form__article">
                        ...
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px" >Stauts Of Accessories</label>
                            <input disabled class="mdl-textfield__input" value="{{ $item['stauts'] }}" type="text" >
                        </div>
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px">Charge Of Accessories</label>
                            <input disabled class="mdl-textfield__input" value="{{ $item['charge'] }}" type="text" >
                        </div>
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px" >Securty Of Accessories</label>
                            <input disabled class="mdl-textfield__input" value="{{ $item['securty'] }}" type="text" >
                        </div>
                        <div class="mdl-textfield mdl-js-textfield full-size">
                            <label style="margin-bottom:10px" >Recovery Of Accessories</label>
