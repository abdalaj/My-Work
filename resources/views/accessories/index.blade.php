...
@endsection
@section('content')
@if (Auth::user()->type =='اكسسورات' || Auth::user()->type =='الكل')
    <br />
    <br />
    <a  href="/accessorie/create" style="margin-left:20px;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['imghome'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['img1'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['img2'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['img3'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['img4'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['img5'] }}" width="50" height="50" />
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <img src="images/accessories/{{ $item['img6'] }}" width="50" height="50" />
                                </td>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="{{ route('accessories.show',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-upgraded=",MaterialButton,MaterialRipple">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric edit">
                                        <a href="{{ route('accessories.edit',$item['id']) }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green" data-upgraded=",MaterialButton,MaterialRipple">
