    ...
    <div class="m-auto text-center mt-md-0 mt-lg-4 mt-sm-0 p-3" style="background:#f7f7fa;width: 96%;color:rgb(64, 69, 83);text-align: right; border-radius: 5px;">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-5  col-sm- p-0  " >
            <div class="row  align-items-stretch justify-content-between">
                ...
                <img class="mb-3" src="https://dash.faster-eg.com/images/accessories/{{ $item->imghome }}" style="width: 100%;" >
                <img class="mb-3" src="https://dash.faster-eg.com/images/accessories/{{ $item->img1 }}" style="width: 100%;" >
                <img class="" src="https://dash.faster-eg.com/images/accessories/{{ $item->img2 }}" style="width: 100%;" >
                </div>
                <div class="col-9 zoom" style="padding-right: 0;">
                    <img  src="https://dash.faster-eg.com/images/accessories/{{ $item->imghome }}" style="width: 100%;height: 100%;"  >
                </div>
                <div class="col-12 mt-2 " style="display: flex;align-items: stretch; justify-content: space-between; flex-wrap: wrap;" >
                    <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/accessories/{{ $item->img3 }}" style="width: 100%;" ></div>
                    <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/accessories/{{ $item->img4 }}" style="width: 100%;" ></div>
                    <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/accessories/{{ $item->img5 }}" style="width: 100%;" ></div>
                    <div style="width: 24%;"><img src="https://dash.faster-eg.com/images/accessories/{{ $item->img6 }}" style="width: 100%;" ></div>
                </div>
                ...
                <div class="modal-dialog">
                    ...
                    <form action="/order" method="POST">
                        ...
                        <div class="modal-body " >
                            ...
                            <div class="form-group">
                            <label for="details"> الحجم وااللون وحالة الدفع</label>
      ...
      <div class="col-12">
        <table class="table table-striped table-bordered text-right" style="text-align: right;">
          ...
          <tbody >
            ...
            <tr>
              <td>رقم البائع</td>
              <td><span class="badge bg-primary" style="line-height: 2;">{{ $item->user_item_id }} </span>&nbsp; يستخدم هذا الرقم للابلاغ عن البائع اذا كانت هناك اي مشاكل ما عليك سوي الابلاغ عن العميل بهذا الرقم لتتخذ فاستر الاجراء المناسب له</td>
            </tr>
          </tbody>
        </table>
      </div>
