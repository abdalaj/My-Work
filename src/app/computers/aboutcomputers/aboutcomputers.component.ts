...
@Component({
  selector: 'app-aboutcomputers',
  templateUrl: './aboutcomputers.component.html',
  styleUrls: ['./aboutcomputers.component.sass']
})
export class AboutcomputersComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.htp.get("https://dash.faster-eg.com/api/computers/"+this.id).subscribe({
