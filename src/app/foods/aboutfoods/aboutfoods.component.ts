...
@Component({
  selector: 'app-aboutfoods',
  templateUrl: './aboutfoods.component.html',
  styleUrls: ['./aboutfoods.component.sass']
})
export class AboutfoodsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.htp.get("https://dash.faster-eg.com/api/foods/"+this.id).subscribe({
