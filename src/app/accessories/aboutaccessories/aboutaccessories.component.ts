...
@Component({
  selector: 'app-aboutaccessories',
  templateUrl: './aboutaccessories.component.html',
  styleUrls: ['./aboutaccessories.component.sass']
})
export class AboutaccessoriesComponent implements OnInit {

  constructor(private htp:HttpClient,private actor:ActivatedRoute,private route:Router) { }
  onedata;
  loader:boolean = true;
  ngOnInit(): void {
    this.htp.get("https://dash.faster-eg.com/api/accessories/"+this.id).subscribe({
