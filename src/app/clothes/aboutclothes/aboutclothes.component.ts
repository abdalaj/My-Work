...
@Component({
  selector: 'app-aboutclothes',
  templateUrl: './aboutclothes.component.html',
  styleUrls: ['./aboutclothes.component.sass']
})
export class AboutclothesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.htp.get("https://dash.faster-eg.com/api/clothes/"+this.id).subscribe({
