...
@Component({
  selector: 'app-abouttoys',
  templateUrl: './abouttoys.component.html',
  styleUrls: ['./abouttoys.component.sass']
})
export class AbouttoysComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.htp.get("https://dash.faster-eg.com/api/toys/"+this.id).subscribe({
