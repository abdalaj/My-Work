...
@Component({
  selector: 'app-aboutmobiles',
  templateUrl: './aboutmobiles.component.html',
  styleUrls: ['./aboutmobiles.component.sass']
})
export class AboutmobilesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.htp.get("https://dash.faster-eg.com/api/mobiles/"+this.id).subscribe({
